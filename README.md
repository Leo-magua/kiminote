...
- 🎨 **富文本编辑器** - 基于 TipTap 的现代化编辑器，支持图片上传、附件、表格、任务列表
- ✍️ **Markdown 支持** - 支持完整的 Markdown 语法（标题、列表、代码块、表格等），可在富文本和 Markdown 之间切换
- 🖼️ **图片上传** - 支持本地图片上传和拖拽上传，自动压缩和存储
- 📎 **附件管理** - 支持上传 PDF、Word、Excel 等各类文档附件
- ↩️ **撤销重做** - 支持编辑操作的撤销和重做（Ctrl+Z / Ctrl+Y）
...
- **富文本编辑器**: TipTap.js (基于 ProseMirror)
